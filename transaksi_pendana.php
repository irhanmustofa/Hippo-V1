      ...
      <div class="card-body">
        <div class="standard-tab">
          <ul class="nav rounded-lg mb-2 p-2 shadow-sm" id="affanTabs1" role="tablist">
            ...
            <li class="nav-item" role="presentation">
              <button class="btn" id="deposit-tab" data-bs-toggle="tab" data-bs-target="#deposit" type="button" role="tab" aria-controls="deposit" aria-selected="false">Deposit</button>
            </li>
            <li class="nav-item" role="presentation">
          ...
          <div class="tab-content rounded-lg p-3 shadow-sm" id="affanTabs1Content">
            ...
            <div class="tab-pane fade show active" id="deposit" role="tabpanel" aria-labelledby="deposit-tab">
              ...
              <?php 
              $link = "getDepositUser&email=" . urlencode($email);
              $output = getRegistran($link);
              if ($output == NULL) { ?>
              ...
              <?php } else{ ?>
                <?php foreach ($output->data as $array_item): ?>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <blockquote class="blockquote mb-0">
                        <p>Deposit Masuk dari rekening <?php echo $array_item->no_rekening; ?> atas nama <?php echo $array_item->nama; ?></p>
                        <footer class="blockquote-footer"><cite title="Source Title">Sebanyak Rp.  <?php echo $array_item->jumlah_transfer; ?></cite></footer>
                      </blockquote>
                    </div>
                  </div>
                <?php endforeach ?>
