  ...
  <div class="container">
    ...
    <div class="card ">
      <div class="card-body">
        ...
        <!-- Dposit Modal -->
        <div class="modal fade bottom-align-modal" id="depositModal" tabindex="-1" aria-labelledby="bottomAlignModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-end">
            <div class="modal-content">
              <div class="modal-header">
                <h6 class="modal-title" id="bottomAlignModalLabel">Pilih Tujuan Deposit</h6>
                <button class="btn btn-close p-1 ms-auto" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <a href="deposit-saldo.php">
                  <div class="form-group">
                    <form class="form-control form-input-lg" id="defaultinputLg" name="defaultinputLg" aria-label="Default input example">
                      <i class="bi bi-wallet2"></i> <label> Saldo</label>
                    </form>
                  </div>
                </a>
              </div>
            ...
            <div class="card-body">
              <div class="row justify-content-center g-3">
                <div class="col-4 text-center">
                  <a class="justify-content-center" data-bs-toggle="modal" data-bs-target="#depositModal" type="button">
