                    ...
                    <div class="card single-product-card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="card-content px-4 py-2">
                                    <!-- Product Title--><a class="product-title d-block text-truncate mt-0" href="page-shop-details.html">Atoms Musk</a>
                                    <!-- Product Price-->
                    ...
                    <div class="card single-product-card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="card-content px-4 py-2">
                                    <!-- Product Title--><a class="product-title d-block text-truncate mt-0" href="page-shop-details.html">Black T-shirt</a>
                                    <!-- Product Price-->
