                    ...
                    <table class="table table-striped table-hover" id="table1">
                        ...
                        <tbody>
                            ...
                            if (isset($_POST['delete'])) {
                                ...
                                $link = "getDeleteBisnis&id_deposit=" . urlencode($id_deposit);
                                $delete = getRegistran($link, $id_deposit);
                                if (!$delete) {
                            ...
                            <?php foreach ($data->data as $array_item) : ?>
                                <tr>
                                    ...
                                    <td><?php echo $array_item->no_rekening; ?></td>
                                    <td><?php echo $array_item->nama; ?></td>
                                    <td><?php echo $array_item->jumlah_transfer; ?></td>
                                    <td class="">
                                        <?php
                                    ...
                                    <td class="d-flex py-3">
                                        <a class="btn btn-warning" href="edit-konfirmasi-deposit.php?id=<?php echo $array_item->id_deposit; ?>"><i class="bi bi-pencil-square"></i></a>
                                        <form action="" method="POST" class="px-2">
                                            <input type="hidden" name="id_deposit" value="<?php echo $array_item->id_deposit; ?>">
